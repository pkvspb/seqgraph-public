...
The files in `lib/` are pre-built, obfuscated distributions of the
SeqComponent library, vendored into this repository and updated periodically
from upstream. `api/mockSeqProcessedValues.js` provides the mock trace data
used by both demos. See [License](#license) for usage terms.
